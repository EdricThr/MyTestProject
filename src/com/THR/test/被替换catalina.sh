...
#
# $Id: catalina.sh,v 1.2 2015/08/22 08:34:45 yingzf Exp $
# -----------------------------------------------------------------------------

CATALINA_OPTS="-server -Xss228k -Xms1500m -Xmx1500m -XX:MaxPermSize=256M -XX:+UseParallelGC -XX:ParallelGCThreads=16 -XX:+UseParallelOldGC -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000"
...
CATALINA_OUT=/kmail/logs/tomcat.log
